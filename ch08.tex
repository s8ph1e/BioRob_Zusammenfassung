...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/verhalten_aufbau.png}}
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/verhalten_ausgabefusion.png}}\par\medskip
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/verhalten_kopplung.png}}
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/verhalten_netzwerke.png}}
	\caption{a) Verhalten -- Aufbau, b) Verhalten -- Ausgabefusion, c) Verhalten -- Kopplung, d) Verhalten -- Netzwerke}
...
\textbf{InBOT} als Beispiel für verhaltesbasierte Steuerung für Fahrzeuge:
\begin{figure}
...
Aufgaben-Orientieres Level:
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/aufgaben_level.png}}
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/aufgaben_level_1.png}}
...
Objekt-Orientiertes Level:
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/objekt_level.png}}
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/objekt_level_1.png}}
...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/objekt_level_hindernis.png}}
	\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/objekt_level_hindernis_1.png}}
