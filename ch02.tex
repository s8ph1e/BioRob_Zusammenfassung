...
\begin{figure}
\centering
\subfloat[]{\includegraphics[width=0.8\textwidth]{figures/befestigungswinkel.png}}\par\medskip
\subfloat[]{\includegraphics[width=0.8\textwidth]{figures/befestigungswinkel_1.png}}
