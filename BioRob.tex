...
%\title{Biologisch Motivierte Robotersysteme}
%\author{Sophie v. Schmettow, Mirjam Jöchner}
...
\section{Einleitung} %(1. VL)
\input{ch01.tex}

\section{Biomechanik} %(2. VL)
\input{ch02.tex}
